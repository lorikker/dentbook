...
export function FacebookIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="#1877F2" className={className} aria-hidden="true">
      <path d="M24 12.07C24 5.83 18.63.79 12 .79S0 5.83 0 12.07c0 5.63 4.39 10.3 10.13 11.14v-7.88H7.08v-3.26h3.05V9.41c0-3.02 1.79-4.69 4.53-4.69 1.31 0 2.68.24 2.68.24v2.95h-1.51c-1.49 0-1.95.93-1.95 1.89v2.27h3.32l-.53 3.26h-2.79v7.88C19.61 22.37 24 17.7 24 12.07Z" />
    </svg>
  );
}
